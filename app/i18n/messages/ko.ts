...
export const ko = {
  common: {
    ...
    scopeTitle: "참고용 예상치",
    scopeDescription:
      "입력한 금액만 사용하며, 세금과 입력하지 않은 결제 조정 항목은 제외됩니다.",
  ...
  metadata: {
    home: {
      ...
      description:
        "호주 부동산 매각 비용, 거래 손익, 선택적 보유 기간 결과, 간소화된 결제 현금 및 목표 매각가를 추정합니다.",
  ...
  home: {
    ...
    footerPrivacyBody:
      "입력값은 이 브라우저에서 계산되며 이 애플리케이션으로 전송되거나 저장되지 않습니다. Cloudflare는 사이트 제공과 보호에 필요한 일반 요청 메타데이터를 처리할 수 있습니다.",
    limitationsTitle: "중요한 한계",
    limitationsBody:
      "선택적 종합 결과와 결제 현금 결과에는 입력한 금액만 사용됩니다. 이 도구는 양도소득세, 소득세, 감가상각, 시간 조정 수익률 또는 세후 이익을 계산하지 않습니다.",
    independence:
  ...
  results: {
    ...
    print: "인쇄 또는 PDF로 저장",
    resultNote:
      "참고용 예상치이며 회계상 이익이나 세금 계산이 아닙니다. 결제 현금에는 입력하지 않은 조정 항목이 제외됩니다. 결정하기 전에 적절한 자격을 갖춘 전문가에게 중요 금액을 확인하세요.",
    ...
    settlementCashLabel: "간소화된 결제 현금",
    ...
    settlementNote:
      "세전이며 입력하지 않은 결제 조정 항목은 제외됩니다. 실제 상환액은 대출기관과 결제 전문가에게 확인하세요.",
  ...
  privacy: {
    ...
    title: "데이터 처리 방식",
    intro:
      "이 계산기는 계정이나 데이터베이스 없이 작동하도록 설계되었습니다. 입력한 재무 정보는 브라우저에만 남습니다.",
  ...
  disclaimer: {
    ...
    adviceBody:
      "이 계산기는 세무, 재무, 법률, 부동산 가치평가, 소유권 이전, 신용, 회계 또는 결제 조언을 제공하지 않습니다. 매각가를 예측하거나 납세 의무를 계산하거나 결제 시 받을 정확한 금액을 산정하지 않습니다. 이 예상치만으로 매각, 매입, 대출 또는 투자 결정을 내리지 마세요.",
    limitationsTitle: "중요한 한계",
    limitations: [
      "결과는 전적으로 입력한 수치와 가정에 따라 달라집니다.",
      "매각 비용 차감 후 금액은 주택담보대출 상환 전입니다. 선택적 결제 현금 예상치는 입력한 대출 상환액만 차감하며 세금, 결제 조정 및 입력하지 않은 금액은 제외합니다.",
      ...
      "이 계산기는 양도소득세, 소득세, 과세 대상 자본이득, 회계상 이익 또는 세후 이익을 계산하지 않습니다.",
    ...
    checkBody:
      "부동산 상황, 거래 비용, 부채 및 세금은 결과에 중대한 영향을 줄 수 있습니다. 회계사, 등록 세무사, 컨베이언서, 변호사 또는 재무 자문가 등 적절한 자격을 갖춘 호주 전문가에게 중요 수치와 결정을 확인하세요. 본 내용은 법적으로 배제할 수 없는 권리나 구제 수단을 배제하지 않습니다.",
